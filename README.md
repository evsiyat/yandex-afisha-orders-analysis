...
В исходной таблице заказов - **292 034 заказов**.
...
* Количество заказов увеличивалось от июня к октябрю; наиболее высокий объем заказов наблюдался в октябре.
...
* Средняя выручка в расчете на один билет различалась между типами мероприятий и менялась между летним и осенним периодами.
